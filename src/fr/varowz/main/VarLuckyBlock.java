...
public class VarLuckyBlock extends JavaPlugin{
	...
	public void onEnable() {
		...
		Bukkit.getConsoleSender().sendMessage(prefix + "§aPlugin §7[§e1.0.5§7] §ais online.");
		Bukkit.getConsoleSender().sendMessage(prefix + "§aPlugin §7[§e1.0.5§7] §cDev by VaroWz.");
		Bukkit.getConsoleSender().sendMessage(prefix + "§aPlugin §7[§e1.0.5§7] §9Discord: https://discord.gg/SbKrKehCpq.");
	}
	...
	public void onDisable() {
		...
		Bukkit.getConsoleSender().sendMessage(prefix + "§cPlugin §7[§e1.0.5§7] §cis offline.");
